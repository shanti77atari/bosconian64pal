...
;formation
formacja	equ *
		lda formacja_stan	; >0 formacja jest juz wlaczona
		bne *+3
		rts
...
@		sta enemyShapeH+5
		...
		mva #>scolor1 enemyOraTab+5
		mva #>scolor0 enemyOraTab+1
		sta enemyOraTab+2
		sta enemyOraTab+3
		sta enemyOraTab+4
		mva #1 enemy+5
...
frm2	equ *	;formacja jest na ekranie, ściga gracza
		...
		lda #$5			;50 punktów extra za dowodcę
		jsr dodajPunkty
...
frm4	equ *
		...
		sta enemyDY+5
		mva #3*16 spyscore	;800
		mva spyScoreX enemyX+5
		mva spyScoreY enemyY+5
		mva #128 enemyDX+5
